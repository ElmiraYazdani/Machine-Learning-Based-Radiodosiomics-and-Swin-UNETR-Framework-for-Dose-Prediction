...
def get_loader(args):
    ...
    train_transform = transforms.Compose(
	    ...
	    # transforms.SpatialPadd(
            # 	keys=["image", "label"],
            #	spatial_size=(96, 96, 96),  # Ensures the smallest dimension is padded to 64
            #	mode='constant'  # You can also try 'edge' or 'reflect'
            #),
	    ...
	    #RandSpatialCropd(keys=["image", "label"], roi_size=(args.roi_x, args.roi_y, args.roi_z), random_size=False),
            ...
            #transforms.Resized(keys=["image", "label"], spatial_size=(96, 96, 64)),
